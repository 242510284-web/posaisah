    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-flex gap-1">
                ...
                ||
                <a href="<?php echo e(route('penjualan.edit', $sale->id)); ?>" class="btn btn-warning">Edit</a>
                ||
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $sale)): ?>
                <form action="<?php echo e(route('penjualan.destroy', $sale->id)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\pos_ica-main\resources\views/penjualan/index.blade.php ENDPATH**/ ?>