...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Tombol Create User -->
        <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-primary px-4 shadow-sm">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-3 fw-semibold text-secondary"><?php echo e($users->firstItem() + $loop->index); ?></td>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn btn-sm btn-info text-white me-1">
                                    Edit Akun
                                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\pos_ica-main\resources\views/users/index.blade.php ENDPATH**/ ?>