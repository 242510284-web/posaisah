...
Route::middleware('auth')->group(function () {
    ...
    // Route untuk Halaman Tentang (Diubah ke tentang.index)
    ...
    // Admin & kasir — produk, jenis-produk, penjualan, item-penjualan
    Route::middleware('role:admin,kasir')->group(function () {
        Route::resource('/produk', ProdukController::class);
        
        Route::resource('/jenis-produk', JenisProdukController::class)->parameters([
